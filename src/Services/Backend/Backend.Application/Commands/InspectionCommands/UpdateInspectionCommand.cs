...
{
    public class UpdateInspectionCommand : IRequest<EntityResponse<bool>>
    {
        ...
        public UpdateInspectionCommand(Guid inspectionId, string name, string dealNumber, Guid inspectorId,
